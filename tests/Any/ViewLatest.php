...
class Example extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testMyTestCase()
  {
        ...
        $this->waitForPageToLoad("10000");
        $this->assertEquals("Documentation:Storm:Installation:WhatsinSplunkInstallationManual:1.1 - PonyDocs", $this->getTitle());
        $this->open("/Documentation/Storm/latest/Installation/WhatsinSplunkInstallationManual");
        $this->assertEquals("Documentation:Storm:Installation:WhatsinSplunkInstallationManual:1.0 - PonyDocs", $this->getTitle());
  }
}
?>